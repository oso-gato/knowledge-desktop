...
# persistent tmux session ("kd"), shared across that user's own devices, never between users (the
# session lives in the user's own $XDG_RUNTIME_DIR/tmux, D2/D3). Profile-based (not sshd
